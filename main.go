...
func (w Walking) Calories() float64 {
	// вставьте ваш код ниже
	return CaloriesWeightMultiplier*w.Weight + ((float64(w.meanSpeed())*2/float64(w.Height)/100)*CaloriesSpeedHeightMultiplier*w.Weight)*float64(w.Duration.Hours())*MinInHours
}
